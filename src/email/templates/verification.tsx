...
export default function Verification({ name, verificationUrl, expiresInMinutes, locale }: VerificationEmailProps) {
        ...
        <Body className="bg-background font-sans">
          ...
          <Container className="mx-auto py-10 px-5 max-w-xl">
            <Section className="bg-surface rounded p-6">
              ...
              <Text className="text-base leading-7 text-gray-800">{t("intro", { name })}</Text>
              <Button
              ...
              <Text className="text-sm text-gray-500 leading-5">{t("expires", { expires: expiresInMinutes })}</Text>
