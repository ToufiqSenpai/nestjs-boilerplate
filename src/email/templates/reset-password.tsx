...
export default function ResetPassword({ name, email, resetUrl, expiresInMinutes, locale }: ResetPasswordProps) {
        ...
        <Body className="bg-background font-sans">
          ...
          <Container className="mx-auto py-10 px-5 max-w-xl">
            <Section className="bg-surface rounded p-6">
              ...
              <Text className="text-base leading-7 text-gray-800">{t("intro", { name, email })}</Text>
              <Text className="text-base leading-7 text-gray-800">{t("expires", { expires: expiresInMinutes })}</Text>
              <Button
                href={resetUrl}
              ...
              <Text className="text-sm text-gray-500 leading-5">{t("ignore")}</Text>
              <Text className="text-sm text-gray-500 leading-5">{t("once")}</Text>
              <Text className="text-sm text-gray-500 leading-5">{t("fallbackLabel")}</Text>
